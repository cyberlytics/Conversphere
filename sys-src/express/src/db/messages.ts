...
export const createMessage = async (text: string, userId: string, roomId: string) => new MessageModel({ text, user_id: userId, room_id: roomId }).save().then(message => message.toObject());
